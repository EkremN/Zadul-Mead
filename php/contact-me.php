...
if($_POST) {
    ...
    $to_Email = 'ekrem@ibu.edu.ba'; // Write your email here to receive the form submissions
    $subject = 'AHIRETSKA OPSKRBA'; // Write the subject you'll see in your inbox
    ...
    // To avoid the spammy bots, you can change the value of the minimum characters required. Here it's <10
